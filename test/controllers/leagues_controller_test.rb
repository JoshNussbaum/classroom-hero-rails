...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { hasStamps: @league.hasStamps, leagueAdmin: @league.leagueAdmin, leagueName: @league.leagueName, private: @league.private }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { hasStamps: @league.hasStamps, leagueAdmin: @league.leagueAdmin, leagueName: @league.leagueName, private: @league.private }
    assert_redirected_to league_path(assigns(:league))
  end
